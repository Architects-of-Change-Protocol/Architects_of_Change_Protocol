 ...
 */
export declare const ProfessionalReviewAction: {
    /**
     ...
     */
    readonly RequestMoreEvidence: "RequestMoreEvidence";
    /**
...
export type ProfessionalReviewAction = (typeof ProfessionalReviewAction)[keyof typeof ProfessionalReviewAction];
/**
 ...
 */
export declare const PROFESSIONAL_REVIEW_ACTIONS: readonly ProfessionalReviewAction[];
export declare function isProfessionalReviewAction(value: unknown): value is ProfessionalReviewAction;
