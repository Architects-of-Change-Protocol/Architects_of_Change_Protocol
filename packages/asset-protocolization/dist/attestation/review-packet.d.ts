import type { AttestationType, CanonicalClaimId, CanonicalEvidenceId, CanonicalPrincipalRef, CanonicalReferenceSource, ClaimType } from '@aoc/protocol/claims';
 ...
 */
export declare const PROFESSIONAL_REVIEW_PACKET_SCHEMA_VERSION = "aoc-protocolization-professional-review-packet/1";
 ...
 */
export declare const ProfessionalReviewParticipantRole: {
    /** Recorded by APV-06 as having made a declaration into this case. */
    readonly Declarant: "Declarant";
};
export type ProfessionalReviewParticipantRole = (typeof ProfessionalReviewParticipantRole)[keyof typeof ProfessionalReviewParticipantRole];
/**
