import type { CanonicalAttestationId, CanonicalCredentialRef, CanonicalPrincipalRef } from '@aoc/protocol/claims';
 ...
 */
export declare const PROFESSIONAL_REVIEW_DECISION_SCHEMA_VERSION = "aoc-protocolization-professional-review-decision/1";
/**
