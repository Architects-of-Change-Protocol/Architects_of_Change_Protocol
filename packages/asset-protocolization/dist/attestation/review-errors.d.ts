 ...
 */
export declare const PROFESSIONAL_REVIEW_ERROR_CODES: Readonly<{
    /** A request or decision input failed structural admission. Carries `reasonCodes`. */
    readonly invalidRequest: "REVIEW_REQUEST_INVALID";
    /** The acting tenant is missing or malformed. */
    readonly invalidTenant: "REVIEW_TENANT_REQUIRED";
    /**
     ...
     */
    readonly tenantMismatch: "REVIEW_TENANT_MISMATCH";
    /** The request names a different case than the one being operated on. */
    readonly caseMismatch: "REVIEW_CASE_MISMATCH";
    /** The request's pin is not the case's pin. */
    readonly profileMismatch: "REVIEW_PROFILE_MISMATCH";
    /** The case is `Cancelled` and accepts no further review workflow. */
    readonly caseCancelled: "REVIEW_CASE_CANCELLED";
    /**
     ...
     * `requirementIds`.
     */
    readonly incompatibleRequirement: "REVIEW_REQUIREMENT_INCOMPATIBLE";
    /**
     ...
     */
    readonly incompatibleAttestationType: "REVIEW_ATTESTATION_TYPE_INCOMPATIBLE";
    ...
    readonly reviewerRequired: "REVIEWER_REQUIRED";
    /** The reviewer is malformed, or is not a principal kind the profile accepts. */
    readonly invalidReviewer: "REVIEWER_INVALID";
    /** The pinned requirement demands a credential and none was presented. */
    readonly credentialRequired: "REVIEWER_CREDENTIAL_REQUIRED";
    /**
     ...
     */
    readonly incompatibleCredential: "REVIEWER_CREDENTIAL_INCOMPATIBLE";
    /** `Attest` was recorded without a scope. */
    readonly scopeRequired: "REVIEW_SCOPE_REQUIRED";
    ...
    readonly reasonCodeRequired: "REVIEW_REASON_CODE_REQUIRED";
    /** `RequestMoreEvidence` was recorded without a machine-readable request. */
    readonly emptyMaterialRequest: "REVIEW_MORE_EVIDENCE_EMPTY";
    ...
    readonly invalidDecision: "REVIEW_DECISION_INVALID";
    /** A request with this (tenantId, reviewRequestId) already exists. */
    readonly duplicateRequest: "REVIEW_REQUEST_DUPLICATE";
    /** A decision with this (tenantId, decisionId) already exists. */
    readonly duplicateDecision: "REVIEW_DECISION_DUPLICATE";
    /**
     ...
     * position.
     */
    readonly alreadyDecided: "REVIEW_REQUEST_ALREADY_DECIDED";
    /** A supplied packet input belongs to another tenant or another case. */
    readonly invalidInputs: "REVIEW_INPUTS_INVALID";
    /** The injected clock returned a non-canonical instant. */
    readonly invalidTimestamp: "REVIEW_TIMESTAMP_INVALID";
}>;
export type ProfessionalReviewErrorCode = (typeof PROFESSIONAL_REVIEW_ERROR_CODES)[keyof typeof PROFESSIONAL_REVIEW_ERROR_CODES];
/**
...
export declare class ProfessionalReviewError extends Error implements ProtocolError {
    readonly code: ProfessionalReviewErrorCode;
    readonly details: ProfessionalReviewErrorDetails;
    constructor(code: ProfessionalReviewErrorCode, message: string, details: ProfessionalReviewErrorDetails);
}
//# sourceMappingURL=review-errors.d.ts.map