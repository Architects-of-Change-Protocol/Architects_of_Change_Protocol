 ...
 */
export declare const PROTOCOLIZATION_CASE_EVENT_TYPES: Readonly<{
    readonly created: "ProtocolizationCaseCreated";
    readonly activated: "ProtocolizationCaseActivated";
    readonly materialAdded: "ProtocolizationMaterialAdded";
    readonly materialAssociated: "ProtocolizationMaterialAssociated";
    readonly cancelled: "ProtocolizationCaseCancelled";
}>;
export type ProtocolizationCaseEventType = (typeof PROTOCOLIZATION_CASE_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_CASE_EVENT_TYPES];
/**
...
export type ProtocolizationCaseEvent = ProtocolizationCaseCreatedEvent | ProtocolizationCaseActivatedEvent | ProtocolizationMaterialAddedEvent | ProtocolizationMaterialAssociatedEvent | ProtocolizationCaseCancelledEvent;
export {};
//# sourceMappingURL=case-events.d.ts.map