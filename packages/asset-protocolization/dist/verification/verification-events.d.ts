 ...
 */
export declare const PROTOCOLIZATION_VERIFICATION_EVENT_TYPES: Readonly<{
    readonly checkExecuted: "ProtocolizationVerificationCheckExecuted";
}>;
export type ProtocolizationVerificationEventType = (typeof PROTOCOLIZATION_VERIFICATION_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_VERIFICATION_EVENT_TYPES];
/** "This declared check ran against this case at this revision and returned this outcome." */
export interface ProtocolizationVerificationCheckExecutedEvent {
    readonly eventType: typeof PROTOCOLIZATION_VERIFICATION_EVENT_TYPES.checkExecuted;
    ...
    /** The case revision evaluated. Unchanged by this execution. */
    readonly evaluatedCaseRevision: number;
    readonly outcome: VerificationCheckOutcome;
    readonly reasonCode?: VerificationReasonCode;
    /** The execution instant. Identical to the result's `executedAt`. */
    readonly occurredAt: UtcDateTime;
    readonly correlationId?: CanonicalId;
}
export type ProtocolizationVerificationEvent = ProtocolizationVerificationCheckExecutedEvent;
