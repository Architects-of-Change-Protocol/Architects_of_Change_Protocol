 ...
 * nobody at all.
 */
export declare const VerificationCheckOutcome: {
    /**
...
export type VerificationCheckOutcome = (typeof VerificationCheckOutcome)[keyof typeof VerificationCheckOutcome];
/**
 ...
 */
export declare const VERIFICATION_CHECK_OUTCOMES: readonly VerificationCheckOutcome[];
export declare function isVerificationCheckOutcome(value: unknown): value is VerificationCheckOutcome;
//# sourceMappingURL=verification-outcome.d.ts.map