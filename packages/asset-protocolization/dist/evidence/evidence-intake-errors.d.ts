 ...
 */
export declare const EVIDENCE_INTAKE_ERROR_CODES: Readonly<{
    /** The submission failed structural admission. Carries `reasonCodes`. */
    readonly invalidSubmission: "EVIDENCE_INTAKE_SUBMISSION_INVALID";
    /** The acting tenant is missing or malformed. */
    readonly invalidTenant: "EVIDENCE_INTAKE_TENANT_REQUIRED";
    /** The acting tenant does not own the case, or the receipt being addressed. */
    readonly tenantMismatch: "EVIDENCE_INTAKE_TENANT_MISMATCH";
    /** The submission names a different case than the one being operated on. */
    readonly caseMismatch: "EVIDENCE_INTAKE_CASE_MISMATCH";
    /** A receipt with this (tenantId, intakeId) already exists. */
    readonly duplicateIntake: "EVIDENCE_INTAKE_DUPLICATE";
    /** This case already holds evidence material naming this canonical evidence. */
    readonly duplicateEvidence: "EVIDENCE_INTAKE_DUPLICATE_EVIDENCE";
    /** A receipt document failed `validateEvidenceIntakeReceipt`. Carries `reasonCodes`. */
    readonly invalidReceipt: "EVIDENCE_INTAKE_RECEIPT_INVALID";
}>;
export type EvidenceIntakeErrorCode = (typeof EVIDENCE_INTAKE_ERROR_CODES)[keyof typeof EVIDENCE_INTAKE_ERROR_CODES];
/**
...
export declare class EvidenceIntakeError extends Error implements ProtocolError {
...
//# sourceMappingURL=evidence-intake-errors.d.ts.map