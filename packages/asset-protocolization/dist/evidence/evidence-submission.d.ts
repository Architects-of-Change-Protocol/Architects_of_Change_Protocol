 ...
 */
export declare const EvidenceIntakePathway: {
    /**
...
export type EvidenceIntakePathway = (typeof EvidenceIntakePathway)[keyof typeof EvidenceIntakePathway];
...
export type ProtocolizationEvidenceSubmission = ReferencedEvidenceSubmission | CanonicalEvidenceSubmission;
export declare function evidenceIntakePayloadKey(pathway: EvidenceIntakePathway): string;
export declare function isEvidenceIntakePathway(value: unknown): value is EvidenceIntakePathway;
export declare const EVIDENCE_SUBMISSION_BASE_KEYS: readonly string[];
/**
 ...
 */
export declare function submittedEvidenceRef(submission: ProtocolizationEvidenceSubmission): CanonicalEvidenceId;
export {};
//# sourceMappingURL=evidence-submission.d.ts.map