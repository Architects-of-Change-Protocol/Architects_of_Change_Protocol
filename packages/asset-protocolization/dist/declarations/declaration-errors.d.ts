...
import type { ProtocolizationCaseId, ProtocolizationMaterialId, ProtocolizationTenantId } from '../case/case-identifiers';
...
export declare const DECLARATION_ERROR_CODES: Readonly<{
     ...
     */
    readonly incompatibleRequirement: "DECLARATION_REQUIREMENT_INCOMPATIBLE";
    /**
     ...
     */
    readonly claimTypeMismatch: "DECLARATION_CLAIM_TYPE_MISMATCH";
    /**
     ...
     * not entitled to ask.
     */
    readonly unknownEvidenceLink: "DECLARATION_EVIDENCE_LINK_UNKNOWN";
    /** A record document failed `validateProtocolizationDeclarationRecord`. Carries `reasonCodes`. */
    readonly invalidRecord: "DECLARATION_RECORD_INVALID";
}>;
export type DeclarationErrorCode = (typeof DECLARATION_ERROR_CODES)[keyof typeof DECLARATION_ERROR_CODES];
/**
 ...
 * `EvidenceIntakeErrorDetails` is one.
 */
export type DeclarationErrorDetails = {
...
export declare class DeclarationError extends Error implements ProtocolError {
    readonly code: DeclarationErrorCode;
    readonly details: DeclarationErrorDetails;
    constructor(code: DeclarationErrorCode, message: string, details: DeclarationErrorDetails);
}
//# sourceMappingURL=declaration-errors.d.ts.map