import type { CanonicalClaimId, CanonicalEvidenceId, CanonicalPrincipalRef, ClaimType } from '@aoc/protocol/claims';
 ...
 */
export declare const PROTOCOLIZATION_DECLARATION_EVENT_TYPES: Readonly<{
    readonly recorded: "ProtocolizationDeclarationRecorded";
}>;
export type ProtocolizationDeclarationEventType = (typeof PROTOCOLIZATION_DECLARATION_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_DECLARATION_EVENT_TYPES];
...
//# sourceMappingURL=declaration-events.d.ts.map