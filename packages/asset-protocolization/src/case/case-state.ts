 ...
 */
export const ProtocolizationCaseState = {
...
export type ProtocolizationCaseState =
  (typeof ProtocolizationCaseState)[keyof typeof ProtocolizationCaseState];
 ...
 */
export const ProtocolizationRequirementMaterialStatus = {
...
export type ProtocolizationRequirementMaterialStatus =
  (typeof ProtocolizationRequirementMaterialStatus)[keyof typeof ProtocolizationRequirementMaterialStatus];
 ...
 */
export const ProtocolizationRequirementConditionStatus = {
...
export type ProtocolizationRequirementConditionStatus =
  (typeof ProtocolizationRequirementConditionStatus)[keyof typeof ProtocolizationRequirementConditionStatus];
 ...
 */
const ALLOWED_TRANSITIONS: Readonly<Record<ProtocolizationCaseState, readonly ProtocolizationCaseState[]>> =
  Object.freeze({
    [ProtocolizationCaseState.Draft]: [ProtocolizationCaseState.Active, ProtocolizationCaseState.Cancelled],
    [ProtocolizationCaseState.Active]: [ProtocolizationCaseState.Cancelled],
    [ProtocolizationCaseState.Cancelled]: [],
  });

/** The state every case starts in. */
export const INITIAL_PROTOCOLIZATION_CASE_STATE = ProtocolizationCaseState.Draft;

export function isProtocolizationCaseState(value: unknown): value is ProtocolizationCaseState {
  return typeof value === 'string' && Object.values<string>(ProtocolizationCaseState).includes(value);
}

export function isAllowedProtocolizationCaseTransition(
  from: ProtocolizationCaseState,
  to: ProtocolizationCaseState,
): boolean {
  return (ALLOWED_TRANSITIONS[from] ?? []).includes(to);
}

/** Which states still accept material. Cancelled cases are read-only. */
export function acceptsProtocolizationMaterial(state: ProtocolizationCaseState): boolean {
  return state === ProtocolizationCaseState.Draft || state === ProtocolizationCaseState.Active;
}
