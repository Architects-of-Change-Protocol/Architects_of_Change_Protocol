...
export function isValidEvidenceIntakeId(value: unknown): value is EvidenceIntakeId {
  return isProtocolizationInstanceIdentifier(value);
}

export function isValidEvidenceIntakeCategoryId(value: unknown): value is EvidenceIntakeCategoryId {
