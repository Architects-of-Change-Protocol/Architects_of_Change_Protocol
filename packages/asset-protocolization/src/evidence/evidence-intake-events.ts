 ...
 */
export const PROTOCOLIZATION_EVIDENCE_EVENT_TYPES = Object.freeze({
  received: 'ProtocolizationEvidenceReceived',
} as const);

export type ProtocolizationEvidenceEventType =
  (typeof PROTOCOLIZATION_EVIDENCE_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_EVIDENCE_EVENT_TYPES];
