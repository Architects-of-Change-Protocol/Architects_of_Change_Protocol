...
export const AssetRequirementKind = {
 ...
 * detectable.
 */
export const AssetRequirementObligation = {
  Required: 'Required',
  Optional: 'Optional',
...
export type AssetRequirementObligation =
  (typeof AssetRequirementObligation)[keyof typeof AssetRequirementObligation];

/** Whether every listed alternative must hold, or any one of them suffices. */
export const AssetRequirementSatisfaction = {
  All: 'All',
  Any: 'Any',
} as const;
export type AssetRequirementSatisfaction =
  (typeof AssetRequirementSatisfaction)[keyof typeof AssetRequirementSatisfaction];
 ...
 */
export const AssetIdentityStrategy = {
