 ...
 */
export const PROTOCOLIZATION_VERIFICATION_EVENT_TYPES = Object.freeze({
  checkExecuted: 'ProtocolizationVerificationCheckExecuted',
} as const);

export type ProtocolizationVerificationEventType =
  (typeof PROTOCOLIZATION_VERIFICATION_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_VERIFICATION_EVENT_TYPES];
