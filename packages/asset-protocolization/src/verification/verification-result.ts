 ...
 */
export const PROTOCOLIZATION_VERIFICATION_RESULT_SCHEMA_VERSION =
  'aoc-protocolization-verification/1';
 ...
 */
export const VerificationInputKind = {
...
export type VerificationInputKind =
  (typeof VerificationInputKind)[keyof typeof VerificationInputKind];
...
export function isVerificationInputKind(value: unknown): value is VerificationInputKind {
  return typeof value === 'string' && Object.values<string>(VerificationInputKind).includes(value);
}
