 ...
 * nobody at all.
 */
export const VerificationCheckOutcome = {
  /**
...
export type VerificationCheckOutcome =
  (typeof VerificationCheckOutcome)[keyof typeof VerificationCheckOutcome];
 ...
 */
export const VERIFICATION_CHECK_OUTCOMES: readonly VerificationCheckOutcome[] = Object.freeze([
...
export function isVerificationCheckOutcome(value: unknown): value is VerificationCheckOutcome {
  return typeof value === 'string' && Object.values<string>(VerificationCheckOutcome).includes(value);
}
