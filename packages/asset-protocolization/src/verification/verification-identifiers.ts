...
export function isValidVerificationExecutionId(value: unknown): value is VerificationExecutionId {
  return isProtocolizationInstanceIdentifier(value);
}

export function isValidVerificationReasonCode(value: unknown): value is VerificationReasonCode {
