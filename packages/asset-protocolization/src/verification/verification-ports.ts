 ...
 */
export const VerificationResolutionStatus = {
...
export type VerificationResolutionStatus =
  (typeof VerificationResolutionStatus)[keyof typeof VerificationResolutionStatus];
