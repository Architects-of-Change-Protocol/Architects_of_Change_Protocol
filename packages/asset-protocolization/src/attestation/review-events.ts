 ...
 */
export const PROFESSIONAL_REVIEW_EVENT_TYPES = Object.freeze({
...
export type ProfessionalReviewEventType =
  (typeof PROFESSIONAL_REVIEW_EVENT_TYPES)[keyof typeof PROFESSIONAL_REVIEW_EVENT_TYPES];
...
export type ProfessionalReviewEvent =
