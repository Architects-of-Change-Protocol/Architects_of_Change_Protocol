import { isDottedToken } from '../identifiers';
...
export function isValidProfessionalReviewRequestId(
  value: unknown,
): value is ProfessionalReviewRequestId {
  return isProtocolizationInstanceIdentifier(value);
}

export function isValidProfessionalReviewDecisionId(
  value: unknown,
): value is ProfessionalReviewDecisionId {
  return isProtocolizationInstanceIdentifier(value);
}

export function isValidProfessionalReviewReasonCode(
  value: unknown,
): value is ProfessionalReviewReasonCode {
