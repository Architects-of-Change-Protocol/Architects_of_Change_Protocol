 ...
 */
export const ProfessionalReviewAction = {
  /**
...
export type ProfessionalReviewAction =
  (typeof ProfessionalReviewAction)[keyof typeof ProfessionalReviewAction];
 ...
 */
export const PROFESSIONAL_REVIEW_ACTIONS: readonly ProfessionalReviewAction[] = Object.freeze([
...
export function isProfessionalReviewAction(value: unknown): value is ProfessionalReviewAction {
  return typeof value === 'string' && Object.values<string>(ProfessionalReviewAction).includes(value);
}
