...
export function createRuntimeClient<TClient extends HostedRuntimeSdk>(client: TClient): TClient {
  return client;
}

export function createSafeRuntimeClient<TClient extends HostedRuntimeSdk>(
  client: TClient,
  options: HostedRuntimeClientOptions
): SdkResult<TClient, 'SDK_CONFIG_ERROR'> {
