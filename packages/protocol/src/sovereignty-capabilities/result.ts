...
export const SOVEREIGNTY_CAPABILITY_RESULT_SCHEMA_VERSION = 'aoc-sovereignty-capability-result/1' as const;
 ...
 */
export type SovereigntyCapabilityResult<TOutput> =
  | SovereigntyCapabilitySuccessResult<TOutput>
 ...
 */
export function resolveSovereigntyCapabilitySubject<TInput, TOutput>(
  invocation: SovereigntyCapabilityInvocation<TInput>,
  outcome: SovereigntyCapabilityExecutionOutcome<TOutput>,
): SovereignSubjectRef | undefined {
