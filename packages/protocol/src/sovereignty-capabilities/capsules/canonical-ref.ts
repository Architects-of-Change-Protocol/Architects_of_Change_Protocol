import { getSovereigntyCapabilityRefByKey, type SovereigntyCapabilityRef } from '../capability-ref';
 ...
 */
export function requireSovereigntyCapabilityRef(key: SovereigntyCapabilityKey): SovereigntyCapabilityRef {
  const ref = getSovereigntyCapabilityRefByKey(key);
  if (ref === undefined) {
