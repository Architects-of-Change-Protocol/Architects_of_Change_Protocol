 ...
 */
export const SOVEREIGN_GOVERNANCE_COMPATIBILITY_REASON_CODES = Object.freeze({
...
export type SovereignGovernanceCompatibilityReasonCode =
  (typeof SOVEREIGN_GOVERNANCE_COMPATIBILITY_REASON_CODES)[keyof typeof SOVEREIGN_GOVERNANCE_COMPATIBILITY_REASON_CODES];
