...
export interface VerificationKeyResolver {
  resolveVerificationKey(
    issuer: CanonicalId,
    proofRef?: CanonicalProofRef,
    context?: AdapterLookupContext,
  ): AdapterResult<VerificationKeyDescriptor | undefined>;
}
...
export interface RevocationLookup {
  lookupRevocationStatus(
    ...
    subjectRef?: CanonicalId,
    context?: AdapterLookupContext,
  ): AdapterResult<RevocationStatus>;
}
...
export interface TrustRegistryProvider {
  ...
  getRegistryEntry(
    ...
    context?: AdapterLookupContext,
  ): AdapterResult<CanonicalRegistryEntry | undefined>;
}
...
export interface CredentialStatusLookup {
  lookupCredentialStatus(
    credentialRef: CanonicalCredentialRef,
    context?: AdapterLookupContext,
  ): AdapterResult<RevocationStatus | undefined>;
}
...
export interface GovernanceDecisionProvider {
  resolveGovernanceDecision(
    ...
    context?: AdapterLookupContext,
  ): AdapterResult<CanonicalDecision | undefined>;
}
...
export interface ExecutionAuthorizationProvider {
  authorizeExecution(
    ...
    context?: AdapterLookupContext,
  ): AdapterResult<ExecutionAuthorizationResult>;
}
