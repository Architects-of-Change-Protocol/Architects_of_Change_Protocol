 ...
 */
export const AOC_SOVEREIGNTY_SEMANTIC_NAMESPACE: CanonicalSemanticNamespace = 'aoc.sovereignty';
...
const term = (
  ...
  Object.freeze({
    ...
    name,
    description,
    namespace: AOC_SOVEREIGNTY_SEMANTIC_NAMESPACE,
  });
 ...
 */
export const AOC_SOVEREIGNTY_SEMANTIC_TERM_IDS = Object.freeze({
...
export type AocSovereigntySemanticTermId =
  (typeof AOC_SOVEREIGNTY_SEMANTIC_TERM_IDS)[keyof typeof AOC_SOVEREIGNTY_SEMANTIC_TERM_IDS];

const TERM_IDS = AOC_SOVEREIGNTY_SEMANTIC_TERM_IDS;
 ...
 */
export const AOC_SOVEREIGNTY_SEMANTIC_TERMS: readonly CanonicalSemanticTerm[] = Object.freeze([
  term(
    TERM_IDS.sovereignSubject,
    'Sovereign Subject',
    'The single thing a sovereign representation is about. A subject may be a file, a building, an '
  ...
  term(
    ...
    'A Protocol-stable identity for the sovereign subject, independent of provider, locator and '
  ...
  term(
    ...
    'External Reference',
    'How some other namespace refers to the same sovereign subject, carried as opaque data. It is '
  ...
  term(
    TERM_IDS.contentIdentity,
    'Content Identity',
    'An integrity commitment to one particular byte representation of a subject. It is not the '
  ...
  term(
    ...
    'Sovereign Manifest',
    'The versioned record describing one state of a sovereign subject: its identity, the registrant '
  ...
  term(
    ...
    'Origin Assertion',
    'An attributable statement about where or how a sovereign subject came to exist. It records that '
  ...
  term(
    ...
    'An attributable statement of authorship or other non-governance standing over a sovereign '
  ...
  term(
    ...
    'An attributable statement that one sovereign subject derives from one or more other sovereign '
  ...
  term(
    ...
    'Claim Standing',
    'A status record about a claim, including the case where a competing assertion exists against it. '
  ...
  term(
    TERM_IDS.portableSovereignRepresentation,
    'Portable Sovereign Representation',
    'A deterministic representation of the sovereign artifacts a caller supplied for one subject, '
...
export const AOC_SOVEREIGNTY_SEMANTIC_CATEGORY_IDS = Object.freeze({
...
const CATEGORY_IDS = AOC_SOVEREIGNTY_SEMANTIC_CATEGORY_IDS;
 ...
 */
export const AOC_SOVEREIGNTY_SEMANTIC_CATEGORIES: readonly CanonicalSemanticCategory[] = Object.freeze([
  category(
    CATEGORY_IDS.identity,
    'Identity Semantics',
    'Concepts describing what a sovereign subject is and how it is named, independent of its bytes.',
    [
      TERM_IDS.sovereignSubject,
      TERM_IDS.sovereignAssetIdentity,
      TERM_IDS.externalReference,
  ...
  category(
    CATEGORY_IDS.integrity,
    'Integrity Semantics',
    'Concepts describing commitments to an exact byte representation of a subject.',
    [TERM_IDS.contentIdentity],
  ),
  category(
    CATEGORY_IDS.provenance,
    'Provenance Semantics',
    'Concepts describing attributable assertions about a subject and the recorded status of those '
      + 'assertions.',
    [
      TERM_IDS.originAssertion,
      TERM_IDS.authorshipAssertion,
  ...
  category(
    CATEGORY_IDS.portability,
    'Portability Semantics',
    'Concepts describing how a sovereign representation travels between environments intact.',
    [TERM_IDS.portableSovereignRepresentation],
  ),
]);

export const AOC_SOVEREIGNTY_SEMANTIC_VOCABULARY_ID: CanonicalSemanticVocabularyId =
  'aoc.sovereignty:core-vocabulary';
 ...
 * anywhere inside it.
 */
export const AOC_SOVEREIGNTY_CORE_SEMANTIC_VOCABULARY: CanonicalSemanticVocabulary = Object.freeze({
  id: AOC_SOVEREIGNTY_SEMANTIC_VOCABULARY_ID,
  name: 'AOC Sovereignty Core Vocabulary',
  description:
    'The Protocol-owned meanings of the concepts that appear in an AOC sovereign representation: '
    ...
    + 'them.',
  namespace: AOC_SOVEREIGNTY_SEMANTIC_NAMESPACE,
  categories: AOC_SOVEREIGNTY_SEMANTIC_CATEGORIES,
});

const TERMS_BY_ID: ReadonlyMap<string, CanonicalSemanticTerm> = new Map(
  AOC_SOVEREIGNTY_SEMANTIC_TERMS.map((entry) => [entry.id, entry]),
);
 ...
 */
export function getAocSovereigntySemanticTerm(id: string): CanonicalSemanticTerm | undefined {
