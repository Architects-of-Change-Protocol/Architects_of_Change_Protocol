...
export interface RuntimeCompositionResult<TContext extends ResolvedRuntimeContext = ResolvedRuntimeContext>
  extends RuntimeBootstrapResult {
...
export interface RuntimeCompositionRoot<
  TOptions extends RuntimeCompositionOptions = RuntimeCompositionOptions,
  TContext extends ResolvedRuntimeContext = ResolvedRuntimeContext,
> {
