 ...
 */
export const LICENSING_TERMS_REASON_CODES = Object.freeze({
  /**
   ...
   */
  subjectRequired: 'LICENSING_TERMS_SUBJECT_REQUIRED',
  invalidInput: 'LICENSING_TERMS_INVALID_INPUT',
  unsupportedOperation: 'LICENSING_TERMS_UNSUPPORTED_OPERATION',
  invalidClaimId: 'LICENSING_TERMS_INVALID_CLAIM_ID',
  invalidStandingId: 'LICENSING_TERMS_INVALID_STANDING_ID',
  invalidIssuer: 'LICENSING_TERMS_INVALID_ISSUER',
  invalidStatement: 'LICENSING_TERMS_INVALID_STATEMENT',
  invalidAudience: 'LICENSING_TERMS_INVALID_AUDIENCE',
  rulesRequired: 'LICENSING_TERMS_RULES_REQUIRED',
  invalidRule: 'LICENSING_TERMS_INVALID_RULE',
  duplicateRuleId: 'LICENSING_TERMS_DUPLICATE_RULE_ID',
  invalidRuleEffect: 'LICENSING_TERMS_INVALID_RULE_EFFECT',
  invalidActionRef: 'LICENSING_TERMS_INVALID_ACTION_REF',
  /** A term inside the Protocol-owned `aoc.licensing` namespace that this version does not define. */
  unknownAocAction: 'LICENSING_TERMS_UNKNOWN_AOC_ACTION',
  invalidTimestamp: 'LICENSING_TERMS_INVALID_TIMESTAMP',
  invalidEvidenceRefs: 'LICENSING_TERMS_INVALID_EVIDENCE_REFS',
  /** The candidate is not a structurally valid claim of the required shape and kind. */
  invalidClaim: 'LICENSING_TERMS_INVALID_CLAIM',
  /**
   ...
   * builder convenience.
   */
  invalidSemanticRefs: 'LICENSING_TERMS_INVALID_SEMANTIC_REFS',
  /** A terms document declaring a schema version this Protocol version does not implement. */
  unsupportedSchema: 'LICENSING_TERMS_UNSUPPORTED_SCHEMA',
  claimSubjectMismatch: 'LICENSING_TERMS_CLAIM_SUBJECT_MISMATCH',
  invalidContestationReason: 'LICENSING_TERMS_INVALID_CONTESTATION_REASON',
} as const);

export type LicensingTermsReasonCode =
  (typeof LICENSING_TERMS_REASON_CODES)[keyof typeof LICENSING_TERMS_REASON_CODES];
