import { type SovereigntyCapabilityId, type SovereigntyCapabilityKey } from './ids';
 ...
 */
export declare function toSovereigntyCapabilityRef(definition: SovereigntyCapabilityDefinition): SovereigntyCapabilityRef;
/**
 ...
 */
export declare function getSovereigntyCapabilityRef(id: unknown): SovereigntyCapabilityRef | undefined;
/** Key-addressed twin of `getSovereigntyCapabilityRef`. */
export declare function getSovereigntyCapabilityRefByKey(key: SovereigntyCapabilityKey | string): SovereigntyCapabilityRef | undefined;
/**
 ...
 */
export declare function isValidSovereigntyCapabilityRef(value: unknown): value is SovereigntyCapabilityRef;
/**
 ...
 */
export declare function sovereigntyCapabilityRefsEqual(a: SovereigntyCapabilityRef, b: SovereigntyCapabilityRef): boolean;
//# sourceMappingURL=capability-ref.d.ts.map