 ...
 */
export declare const SOVEREIGNTY_CAPABILITY_INVOCATION_ERROR_CODES: Readonly<{
    /** Metadata was rejected before the implementation was called. No evidence: the invocation was never accepted. */
    readonly rejected: "SOVEREIGNTY_CAPABILITY_INVOCATION_REJECTED";
    /** The implementation threw, or returned something that is not a valid outcome. A bug, not a result. */
    readonly implementationError: "SOVEREIGNTY_CAPABILITY_IMPLEMENTATION_ERROR";
    /** An explicitly configured evidence sink did not accept the record. */
    readonly evidenceDeliveryFailed: "SOVEREIGNTY_CAPABILITY_EVIDENCE_DELIVERY_FAILED";
}>;
export type SovereigntyCapabilityInvocationErrorCode = (typeof SOVEREIGNTY_CAPABILITY_INVOCATION_ERROR_CODES)[keyof typeof SOVEREIGNTY_CAPABILITY_INVOCATION_ERROR_CODES];
/**
 ...
 */
export declare class SovereigntyCapabilityInvocationError extends Error implements ProtocolError {
    ...
    constructor(code: SovereigntyCapabilityInvocationErrorCode, details: SovereigntyCapabilityInvocationErrorDetails, options?: {
        readonly cause?: unknown;
        readonly evidence?: SovereigntyCapabilityInvocationEvidenceV1;
    });
}
export declare function isSovereigntyCapabilityInvocationError(value: unknown): value is SovereigntyCapabilityInvocationError;
