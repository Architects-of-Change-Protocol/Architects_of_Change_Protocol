 ...
 * looking at.
 */
export declare const SOVEREIGN_LICENSE_TERMS_SCHEMA_VERSION: "aoc-sovereign-license-terms/1";
 ...
 */
export declare const SovereignLicenseTermsAudienceKind: {
    /**
...
export type SovereignLicenseTermsAudienceKind = (typeof SovereignLicenseTermsAudienceKind)[keyof typeof SovereignLicenseTermsAudienceKind];
/** Every canonical audience kind, in a stable order, for validation and discovery. */
export declare const SOVEREIGN_LICENSE_TERMS_AUDIENCE_KINDS: readonly SovereignLicenseTermsAudienceKind[];
...
export type SovereignLicenseTermsAudience = SovereignLicenseTermsPublicAudience | SovereignLicenseTermsPrincipalAudience | SovereignLicenseTermsCustomAudience;
/**
 ...
 */
export declare const SovereignLicenseTermsRuleEffect: {
...
export type SovereignLicenseTermsRuleEffect = (typeof SovereignLicenseTermsRuleEffect)[keyof typeof SovereignLicenseTermsRuleEffect];
/** Every canonical effect, in a stable order, for validation and discovery. */
export declare const SOVEREIGN_LICENSE_TERMS_RULE_EFFECTS: readonly SovereignLicenseTermsRuleEffect[];
/**
