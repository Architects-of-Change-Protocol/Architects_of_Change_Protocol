...
exports.AOC_LICENSE_TERMS_SEMANTIC_VOCABULARY = exports.AOC_LICENSE_TERMS_SEMANTIC_VOCABULARY_ID = exports.AOC_LICENSING_SEMANTIC_CATEGORIES = exports.AOC_LICENSING_SEMANTIC_CATEGORY_IDS = exports.AOC_LICENSING_SEMANTIC_TERMS = exports.AOC_LICENSING_SEMANTIC_TERM_IDS = exports.AOC_LICENSING_ACTION_TERM_IDS = exports.AOC_LICENSING_DECLARATION_TERM_IDS = exports.AOC_LICENSING_SEMANTIC_NAMESPACE = void 0;
exports.getAocLicensingSemanticTerm = getAocLicensingSemanticTerm;
exports.isAocLicensingActionTermId = isAocLicensingActionTermId;
/**
 ...
 */
exports.AOC_LICENSING_SEMANTIC_NAMESPACE = 'aoc.licensing';
const term = (id, name, description) => Object.freeze({
    id,
    name,
    description,
    namespace: exports.AOC_LICENSING_SEMANTIC_NAMESPACE,
});
/**
 * The concepts describing the licensing declaration itself and the three
 * clause effects it can carry.
 */
exports.AOC_LICENSING_DECLARATION_TERM_IDS = Object.freeze({
 ...
 */
exports.AOC_LICENSING_ACTION_TERM_IDS = Object.freeze({
...
exports.AOC_LICENSING_SEMANTIC_TERM_IDS = Object.freeze({
    ...exports.AOC_LICENSING_DECLARATION_TERM_IDS,
    ...exports.AOC_LICENSING_ACTION_TERM_IDS,
});
const TERM_IDS = exports.AOC_LICENSING_SEMANTIC_TERM_IDS;
/**
 ...
 */
exports.AOC_LICENSING_SEMANTIC_TERMS = Object.freeze([
    term(TERM_IDS.licenseTermsDeclaration, 'License Terms Declaration', 'An attributable, structured statement of the permissions, restrictions and obligations an issuer '
    ...
    term(TERM_IDS.permissionRule, 'Permission Rule', 'A clause declaring an action permitted under the terms. It is a declaration, not a runtime grant: '
        + 'it issues no capability, token, credential or access, and produces no authorization result.'),
    term(TERM_IDS.restrictionRule, 'Restriction Rule', 'A clause declaring an action restricted under the terms. It is a declaration, not an enforced '
        + 'denial: nothing is blocked, revoked, disabled or prevented by its presence.'),
    term(TERM_IDS.obligationRule, 'Obligation Rule', 'A clause declaring an action required under the terms. It is a declaration, not evidence of '
    ...
    term(TERM_IDS.derive, 'Derive', 'Producing a new subject from this one. A declaration about deriving says nothing about what terms '
        + 'the resulting subject carries: nothing is inherited along a derivation edge.'),
    term(TERM_IDS.commercialUse, 'Commercial Use', 'Using the subject in a commercial context. Protocol assigns no price, computes no royalty and '
        + 'settles no payment for it.'),
    term(TERM_IDS.sublicense, 'Sublicense', 'Declaring further terms over the subject to a further audience. Protocol neither performs nor '
        + 'validates a sublicensing chain.'),
    term(TERM_IDS.attribute, 'Attribute', 'Crediting an asserted author or source. Protocol records the concept; it never checks that '
...
exports.AOC_LICENSING_SEMANTIC_CATEGORY_IDS = Object.freeze({
...
const CATEGORY_IDS = exports.AOC_LICENSING_SEMANTIC_CATEGORY_IDS;
/**
 ...
 * anything.
 */
exports.AOC_LICENSING_SEMANTIC_CATEGORIES = Object.freeze([
    category(CATEGORY_IDS.declaration, 'Licensing Declaration Semantics', 'What a structured terms declaration over a sovereign subject is, and what it does not establish.', [TERM_IDS.licenseTermsDeclaration]),
    category(CATEGORY_IDS.effect, 'Licensing Effect Semantics', 'What each clause effect declares — and, in every case, what it deliberately does not do.', [TERM_IDS.permissionRule, TERM_IDS.restrictionRule, TERM_IDS.obligationRule]),
    category(CATEGORY_IDS.action, 'Licensing Action Semantics', 'The Protocol-owned core action concepts a clause may be about. Not exhaustive: external '
...
exports.AOC_LICENSE_TERMS_SEMANTIC_VOCABULARY_ID = 'aoc.licensing:license-terms-vocabulary';
/**
 ...
 * anywhere inside it.
 */
exports.AOC_LICENSE_TERMS_SEMANTIC_VOCABULARY = Object.freeze({
    id: exports.AOC_LICENSE_TERMS_SEMANTIC_VOCABULARY_ID,
    name: 'AOC Licensing & Terms Vocabulary',
    description: 'The Protocol-owned meanings of the concepts that appear in a structured sovereign license terms '
    ...
    namespace: exports.AOC_LICENSING_SEMANTIC_NAMESPACE,
    categories: exports.AOC_LICENSING_SEMANTIC_CATEGORIES,
});
const TERMS_BY_ID = new Map(exports.AOC_LICENSING_SEMANTIC_TERMS.map((entry) => [entry.id, entry]));
const ACTION_TERM_IDS = new Set(Object.values(exports.AOC_LICENSING_ACTION_TERM_IDS));
/**
 ...
 */
function getAocLicensingSemanticTerm(id) {
 ...
 */
function isAocLicensingActionTermId(value) {
