...
export type CapabilityPermission = 'resource:read' | 'resource:create' | 'resource:update' | 'resource:delete' | 'resource:execute' | 'governance:approve' | 'governance:manage' | 'identity:delegate' | 'workspace:manage' | 'project:manage' | 'membership:manage' | 'billing:manage' | 'agent:manage' | 'agent:execute' | 'document:upload' | 'memory:read' | 'memory:write' | 'memory:delete' | 'audit:read' | 'audit:export';
export type CapabilityResourceType = 'workspace' | 'project' | 'document' | 'dataset' | 'policy' | 'consent' | 'delegation' | 'audit_log' | 'agent' | 'memory' | 'execution' | 'integration';
...
export type AuditEventCategory = 'capability' | 'delegation' | 'policy' | 'consent' | 'agent' | 'authorization' | 'audit' | 'identity';
export type AuditSeverity = 'debug' | 'info' | 'notice' | 'warning' | 'error' | 'critical';
export type AuditEventType = 'capability.requested' | 'capability.granted' | 'capability.revoked' | 'delegation.created' | 'delegation.revoked' | 'policy.evaluated' | 'consent.updated' | 'agent.action' | 'authorization.failed' | 'audit.exported' | 'scope.violation';
...
//# sourceMappingURL=legacy-contracts.d.ts.map