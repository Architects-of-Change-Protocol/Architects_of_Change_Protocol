...
import { type SovereigntyInteroperabilityDescriptorV1 } from './descriptor';
...
export declare const SOVEREIGNTY_INTEROPERABILITY_REPORT_SCHEMA_VERSION: "aoc-sovereignty-interoperability-report/1";
export type SovereigntyInteroperabilityReportSchemaVersion = typeof SOVEREIGNTY_INTEROPERABILITY_REPORT_SCHEMA_VERSION;
/**
 ...
 */
export declare const SOVEREIGNTY_INTEROPERABILITY_COMPATIBILITY_STATUSES: readonly ["compatible", "partially-compatible", "incompatible"];
export type SovereigntyInteroperabilityCompatibilityStatus = (typeof SOVEREIGNTY_INTEROPERABILITY_COMPATIBILITY_STATUSES)[number];
/**
 ...
 */
export declare function assessSovereigntyInteroperabilityCompatibility(descriptor: SovereigntyInteroperabilityDescriptorV1, consumerSupport: SovereigntyInteroperabilityConsumerSupportV1): SovereigntyInteroperabilityCompatibilityReportV1;
