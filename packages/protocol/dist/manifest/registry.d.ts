 ...
 */
export declare function resolveSovereignAsset(sovereignAssetRegistry: SovereignAssetRegistry, sovereignAssetId: SovereignAssetId): SignedSovereignManifest | null | Promise<SignedSovereignManifest | null>;
