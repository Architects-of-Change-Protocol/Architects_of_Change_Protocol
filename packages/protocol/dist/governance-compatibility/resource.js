...
exports.SOVEREIGN_GOVERNED_RESOURCE_KIND = void 0;
exports.buildSovereignGovernanceResourceRef = buildSovereignGovernanceResourceRef;
 ...
 */
exports.SOVEREIGN_GOVERNED_RESOURCE_KIND = 'aoc:sovereign-asset';
 ...
 * instead.
 */
function buildSovereignGovernanceResourceRef(subject, options) {
    if (!(0, identity_1.isValidSovereignSubjectRef)(subject)) {
    ...
    return Object.freeze({
        kind: exports.SOVEREIGN_GOVERNED_RESOURCE_KIND,
