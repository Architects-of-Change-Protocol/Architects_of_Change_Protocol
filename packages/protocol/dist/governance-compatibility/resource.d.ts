 ...
 */
export declare const SOVEREIGN_GOVERNED_RESOURCE_KIND: "aoc:sovereign-asset";
 ...
 * instead.
 */
export declare function buildSovereignGovernanceResourceRef(subject: SovereignSubjectRef, options?: BuildSovereignGovernanceResourceRefOptions): ResourceRef;
