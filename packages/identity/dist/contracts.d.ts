...
export declare const identityContractSchemaExample: {
    readonly $id: "https://aoc.protocol/schemas/identity-contract/1-0-0";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["schemaVersion", "id", "principalType", "status", "createdAt", "updatedAt", "claims", "trust", "tenant"];
};
