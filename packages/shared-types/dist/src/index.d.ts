...
export interface MachineDelegationTopology {
    edges: Array<{
        fromMachineActorId: string;
        toMachineActorId: string;
        scopeCapabilityIds: string[];
        scopeNamespacePaths: string[];
        delegatedAt: string;
        revokedAt?: string;
    }>;
}
export interface MachineBehaviorConstraintState {
    policies: Array<{
        policyId: string;
        executionCeiling: number;
        actionQuota: number;
...
export interface MachineObligationHistory {
    obligations: Array<{
        obligationId: string;
        machineActorId: string;
...
export interface GovernanceSnapshot {
    ...
    machineAuthority?: MachineAuthoritySnapshot;
    machineDelegation?: MachineDelegationTopology;
    machineConstraintState?: MachineBehaviorConstraintState;
    machineObligationHistory?: MachineObligationHistory;
    resourceAuthorityProfiles?: ResourceAuthorityProfile[];
    cognitionBudgets?: CognitionBudget[];
    executionCostProfiles?: ExecutionCostProfile[];
    resourceConstraintPolicies?: ResourceConstraintPolicy[];
    delegatedResourceGrants?: DelegatedResourceGrant[];
    resourceLineage?: ResourceLineageEntry[];
    resourceObligations?: ResourceObligation[];
}
