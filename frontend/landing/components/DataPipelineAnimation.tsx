    ...
    <div className="w-full max-w-[420px] aspect-[16/9] flex items-center justify-center">
      <svg viewBox="0 0 800 450" className="w-full h-full">
        ...
        <g transform="translate(330,150)">
          ...
          <rect x="30" y="35" width="80" height="50" rx="2" fill="rgba(0,0,0,0.52)" stroke="rgba(255,42,42,0.45)" strokeWidth="1.4" />
          <line x1="0" y1="95" x2="140" y2="95" stroke="rgba(255,42,42,0.38)" strokeWidth="2" strokeDasharray="8 4" />
        ...
        <g transform="translate(650,150)">
          ...
          <ellipse cx="75" cy="20" rx="12" ry="14" fill="rgba(18,18,26,0.96)" stroke="rgba(255,42,42,0.2)" strokeWidth="1" />
          <path d="M 75 34 L 75 60 L 68 80 L 82 80 L 75 60" fill="rgba(18,18,26,0.96)" stroke="rgba(255,42,42,0.2)" strokeWidth="1" />
