  ...
  return (
    <main className="assurance-support-page min-h-screen bg-[#070d0b] text-white font-sans">
      <nav className="assurance-support-nav" aria-label="Support page navigation">
        <a href="/?view=intelligence-risk" className="assurance-support-brand" aria-label="Back to AOC Intelligence Risk">
          <LogoRotating size={28} inverted />
          <span>AOC Intelligence Risk</span>
        </a>
        <a href="/?view=intelligence-risk" className="assurance-support-back">← Back to Intelligence Risk</a>
      </nav>
...
const privacySections: Section[] = [
  { title: 'Overview', body: ['AOC Intelligence Risk is a constitutional assessment framework developed by AOC Protocol. This Privacy Policy explains how information may be collected, used, and protected when users interact with AOC Intelligence Risk pages, assessment offerings, forms, communications, and related services.'] },
  ...
  { title: 'Payment Processing', body: ['Payments may be processed through third-party payment providers such as Stripe. AOC Intelligence Risk does not store full payment card details.'] },
  { title: 'Third-Party Services', body: ['AOC Intelligence Risk may use third-party services for forms, payments, analytics, hosting, communications, and external content. These services may process information according to their own privacy policies.'] },
  { title: 'How We Use Information', body: ['Information may be used to deliver assessments, communicate with users, improve methodology, respond to inquiries, process requests, maintain records, and improve AOC Intelligence Risk services.'] },
  ...
  { title: 'Confidential Materials', body: ['If non-public materials are submitted, AOC Intelligence Risk will treat them as assessment materials and will not intentionally publish confidential materials without permission, unless otherwise agreed.'] },
  { title: 'Contact', body: ['Questions about this Privacy Policy can be submitted through the Contact Us link.'] },
];

const termsSections: Section[] = [
  { title: 'Overview', body: ['AOC Intelligence Risk provides constitutional assessment, research, indexing, and advisory materials related to AI governance and sovereignty.'] },
  { title: 'Nature of Assessments', body: ['AOC Intelligence Risk assessments are analytical evaluations based on publicly observable evidence and/or submitted materials. They are intended to help organizations understand constitutional posture, identify limiting factors, and improve governance and sovereignty characteristics.'] },
  { title: 'No Certification', body: ['AOC Intelligence Risk does not certify organizations as safe, secure, compliant, trustworthy, or risk-free. Scores, findings, rankings, and reports are analytical opinions based on available evidence and should not be interpreted as guarantees, certifications, legal advice, compliance determinations, or endorsements.'] },
  ...
  { title: 'Intellectual Property', body: ['AOC Intelligence Risk, AOC Protocol, the Constitutional Index, Constitutional Matrix, methodology, scoring model, reports, copy, designs, and related materials are owned by or licensed to OnchainFest LLC unless otherwise stated.'] },
  ...
  { title: 'Third-Party Links', body: ['AOC Intelligence Risk pages may link to external websites, services, repositories, articles, and payment providers. AOC Intelligence Risk is not responsible for third-party content, policies, or services.'] },
  { title: 'Limitation of Liability', body: ['To the maximum extent permitted by applicable law, OnchainFest LLC and related AOC initiatives are not liable for indirect, incidental, consequential, special, or punitive damages arising from use of AOC Intelligence Risk materials or services.'] },
  { title: 'Contact', body: ['Questions about these Terms can be submitted through the Contact Us link.'] },
];

export function PrivacyPage() { return <SupportLayout title="Privacy Policy" subtitle="How AOC Intelligence Risk handles information submitted through assessments, forms, communications, and related services." updated="Last updated: June 2026"><TextSections sections={privacySections} /><ContactCta /></SupportLayout>; }
export function TermsPage() { return <SupportLayout title="Terms of Service" subtitle="Terms governing access to AOC Intelligence Risk assessments, research, pages, and related services." updated="Last updated: June 2026"><TextSections sections={termsSections} /><ContactCta /></SupportLayout>; }
...
export function MethodologyPage() {
  const sections: Section[] = [
    ...
    { title: 'Evidence Model', body: ['AOC Intelligence Risk may evaluate:'], bullets: ['Public websites', 'Documentation', 'Security pages', 'Trust centers', 'Repositories', 'Policies', 'Product architecture disclosures', 'Terms and privacy materials', 'Governance disclosures', 'Customer control and portability signals', 'Submitted evidence for paid assessments'] },
