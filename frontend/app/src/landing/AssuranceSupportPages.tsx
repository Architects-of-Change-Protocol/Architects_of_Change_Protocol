  ...
  return (
    <main className="assurance-support-page min-h-screen bg-[#070d0b] text-white font-sans">
      <nav className="assurance-support-nav" aria-label="Support page navigation">
        <a href="/assurance/intelligence-risk" className="assurance-support-brand" aria-label="Back to AOC Assurance">
...
export function MethodologyPage() {
  ...
  return <SupportLayout title="Constitutional Index Methodology" subtitle="How AOC Assurance evaluates Governance, Sovereignty, and Constitutional Position." updated="Methodology v1.0 — June 2026"><TextSections sections={sections} /><div className="assurance-support-actions"><a className="assurance-support-primary" href="/assurance/intelligence-risk">Explore AOC Assurance</a><a className="assurance-support-secondary" href={CONTACT_MAILTO}>Contact Us</a></div></SupportLayout>;
}
