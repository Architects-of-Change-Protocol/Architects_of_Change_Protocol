  ...
  return (
    <main className="assurance-support-page min-h-screen bg-[#070d0b] text-white font-sans">
      <nav className="assurance-support-nav" aria-label="Support page navigation">
        <a href="/assurance/intelligence-risk" className="assurance-support-brand" aria-label="Back to Soberanía Assurance">
          <LogoRotating size={28} inverted />
          <span>Soberanía Assurance</span>
        </a>
        <a href="/assurance/intelligence-risk" className="assurance-support-back">← Back to Assurance</a>
      </nav>
...
const privacySections: Section[] = [
  { title: 'Overview', body: ['Soberanía Assurance is a constitutional assessment framework developed by Soberanía Protocol. This Privacy Policy explains how information may be collected, used, and protected when users interact with Soberanía Assurance pages, assessment offerings, forms, communications, and related services.'] },
  ...
  { title: 'Payment Processing', body: ['Payments may be processed through third-party payment providers such as Stripe. Soberanía Assurance does not store full payment card details.'] },
  { title: 'Third-Party Services', body: ['Soberanía Assurance may use third-party services for forms, payments, analytics, hosting, communications, and external content. These services may process information according to their own privacy policies.'] },
  { title: 'How We Use Information', body: ['Information may be used to deliver assessments, communicate with users, improve methodology, respond to inquiries, process requests, maintain records, and improve Soberanía Assurance services.'] },
  ...
  { title: 'Confidential Materials', body: ['If non-public materials are submitted, Soberanía Assurance will treat them as assessment materials and will not intentionally publish confidential materials without permission, unless otherwise agreed.'] },
  { title: 'Contact', body: ['Questions about this Privacy Policy can be submitted through the Contact Us link.'] },
];

const termsSections: Section[] = [
  { title: 'Overview', body: ['Soberanía Assurance provides constitutional assessment, research, indexing, and advisory materials related to AI governance and sovereignty.'] },
  { title: 'Nature of Assessments', body: ['Soberanía Assurance assessments are analytical evaluations based on publicly observable evidence and/or submitted materials. They are intended to help organizations understand constitutional posture, identify limiting factors, and improve governance and sovereignty characteristics.'] },
  { title: 'No Certification', body: ['Soberanía Assurance does not certify organizations as safe, secure, compliant, trustworthy, or risk-free. Scores, findings, rankings, and reports are analytical opinions based on available evidence and should not be interpreted as guarantees, certifications, legal advice, compliance determinations, or endorsements.'] },
  ...
  { title: 'Intellectual Property', body: ['Soberanía Assurance, Soberanía Protocol, the Constitutional Index, Constitutional Matrix, methodology, scoring model, reports, copy, designs, and related materials are owned by or licensed to OnchainFest LLC unless otherwise stated.'] },
  ...
  { title: 'Third-Party Links', body: ['Soberanía Assurance pages may link to external websites, services, repositories, articles, and payment providers. Soberanía Assurance is not responsible for third-party content, policies, or services.'] },
  { title: 'Limitation of Liability', body: ['To the maximum extent permitted by applicable law, OnchainFest LLC and related Soberanía initiatives are not liable for indirect, incidental, consequential, special, or punitive damages arising from use of Soberanía Assurance materials or services.'] },
  { title: 'Contact', body: ['Questions about these Terms can be submitted through the Contact Us link.'] },
];

export function PrivacyPage() { return <SupportLayout title="Privacy Policy" subtitle="How Soberanía Assurance handles information submitted through assessments, forms, communications, and related services." updated="Last updated: June 2026"><TextSections sections={privacySections} /><ContactCta /></SupportLayout>; }
export function TermsPage() { return <SupportLayout title="Terms of Service" subtitle="Terms governing access to Soberanía Assurance assessments, research, pages, and related services." updated="Last updated: June 2026"><TextSections sections={termsSections} /><ContactCta /></SupportLayout>; }

export function MethodologyPage() {
  const sections: Section[] = [
    { title: 'Purpose', body: ['The Soberanía Constitutional Index evaluates how AI organizations balance two independent dimensions: Governance and Sovereignty. The goal is not only to produce a score, but to understand where an organization sits, why it sits there, and what would need to change to improve its constitutional posture.'] },
    ...
    { title: 'Evidence Model', body: ['Soberanía Assurance may evaluate:'], bullets: ['Public websites', 'Documentation', 'Security pages', 'Trust centers', 'Repositories', 'Policies', 'Product architecture disclosures', 'Terms and privacy materials', 'Governance disclosures', 'Customer control and portability signals', 'Submitted evidence for paid assessments'] },
  ...
  return <SupportLayout title="Constitutional Index Methodology" subtitle="How Soberanía Assurance evaluates Governance, Sovereignty, and Constitutional Position." updated="Methodology v1.0 — June 2026"><TextSections sections={sections} /><div className="assurance-support-actions"><a className="assurance-support-primary" href="/assurance/intelligence-risk">Explore Soberanía Assurance</a><a className="assurance-support-secondary" href={CONTACT_MAILTO}>Contact Us</a></div></SupportLayout>;
}

export function ResearchPage() {
  return <SupportLayout title="Public Research Initiative" subtitle="Tracking how AI organizations balance Governance and Sovereignty over time." updated="Research status: Early and evolving"><div className="assurance-support-content"><section className="assurance-support-section"><p>Soberanía Assurance is building a public research initiative to evaluate the constitutional posture of AI organizations using publicly observable evidence.</p><p>The objective is to understand the structural trade-offs behind AI business models, deployment patterns, operating models, and control surfaces.</p></section><section className="assurance-support-section"><h2>Research Focus</h2><ul>{['Governance maturity','Sovereignty maturity','Dependency patterns','Portability and exit feasibility','Auditability and accountability','Constitutional trade-offs','Roadmaps toward stronger constitutional posture'].map((item)=><li key={item}>{item}</li>)}</ul></section><section className="assurance-support-section"><h2>Current Index Coverage</h2><div className="assurance-research-grid">{CONSTITUTIONAL_INDEX_ORGANIZATIONS.map((org)=><a key={org.id} href={`/assurance/index/${org.slug}`} className="assurance-research-card"><strong>{org.name}</strong><span>{org.quadrantLabel}</span></a>)}</div></section><section className="assurance-support-section"><h2>Research Status</h2><p>This initiative is early and evolving. Scores and findings may be updated as new evidence becomes available.</p></section></div><div className="assurance-support-actions"><a className="assurance-support-primary" href="/assurance/intelligence-risk#index">Explore the Constitutional Index</a><a className="assurance-support-secondary" href={FOUNDER_ESSAY_URL} target="_blank" rel="noopener noreferrer">Read the Founder Essay ↗</a></div></SupportLayout>;
}

export function AboutPage() {
  return <SupportLayout title="About Soberanía Assurance" subtitle="A constitutional assessment framework for understanding AI Governance, Sovereignty, and the balance between them." updated="Soberanía Assurance"><div className="assurance-support-content"><section className="assurance-support-section"><p>Soberanía Assurance is a constitutional assessment framework developed by Soberanía Protocol.</p><p>It was created to help organizations understand where AI companies, platforms, and systems sit across two dimensions that are often discussed separately but rarely measured together: Governance and Sovereignty.</p><p>Governance shows how a system is supervised, controlled, audited, and made accountable.</p><p>Sovereignty shows who truly controls the capability, who can operate it, move it, replace it, and preserve independence over time.</p></section><section className="assurance-support-section"><h2>Soberanía Assurance exists to help organizations:</h2><ul>{['Measure constitutional posture','Understand limiting factors','Compare governance and sovereignty trade-offs','Build roadmaps toward stronger constitutional maturity','Avoid confusing trust with governance alone'].map((item)=><li key={item}>{item}</li>)}</ul></section><section className="assurance-support-section"><p><strong>Soberanía Assurance and Soberanía Protocol are initiatives of OnchainFest LLC.</strong></p></section></div><div className="assurance-support-actions"><a className="assurance-support-primary" href="/assurance/intelligence-risk#index">Explore the Constitutional Index</a><a className="assurance-support-secondary" href={CONTACT_MAILTO}>Contact Us</a></div></SupportLayout>;
}
