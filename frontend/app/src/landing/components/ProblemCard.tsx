...
export function ProblemCard({ title, children }: ProblemCardProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-red-800/30 bg-red-950/10 p-4 md:p-10 min-h-[280px] md:min-h-[420px] hover:-translate-y-1 transition">
      ...
      <div className="relative flex h-full flex-col justify-between gap-4 md:gap-8">
        ...
        <p className="text-lg md:text-2xl text-red-100 leading-snug">{title}</p>
      </div>
    </div>
  );
}
