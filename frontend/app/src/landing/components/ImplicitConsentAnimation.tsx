  ...
  return (
    <div className="w-full max-w-[420px] aspect-[16/9] flex items-center justify-center">
      <svg viewBox="0 0 800 450" className="w-full h-full">
        ...
        <g transform="translate(250,40)">
          ...
          <g transform="translate(22,374)">
            <rect
              ...
              fill="#d90000"
            >
              <animate attributeName="fill-opacity" values="0.92;1;0.92" dur="1.6s" repeatCount="indefinite" />
            </rect>
            <text
              x="158"
              y="28"
        ...
        {/* forced-consent escaped checkbox below */}
        <g transform="translate(470,396)">
          ...
          <circle cx="8" cy="40" r="2" fill="#ff3a3a">
            <animate attributeName="opacity" values="0.15;0.8;0.15" dur="1.8s" begin="0.15s" repeatCount="indefinite" />
          </circle>
          <circle cx="20" cy="46" r="1.8" fill="#ff3a3a">
            <animate attributeName="opacity" values="0.1;0.6;0.1" dur="1.8s" begin="0.3s" repeatCount="indefinite" />
          </circle>
        </g>
      </svg>
    </div>
