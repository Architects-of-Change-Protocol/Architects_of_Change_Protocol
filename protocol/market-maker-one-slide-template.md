# Soberanía Market Maker v1 — Canonical End-to-End Flow Template (One Slide)

Use this template for any domain-specific market maker (health, education, finance) built on Soberanía v0.1.
...
└─────┬───────┘      └──────────┬─────────┘      └──────┬───────┘
      ...
      ▼                         │                       │
┌─────────────────────────────────────────────────────────────────────────┐
│ Soberanía Protocol (vault / consent / capability)                            │
...
└─────────────────────────────────────────────────────────────────────────┘
                  ...
                  [BUYER] receives scoped, expiring, audience-bound capability
                              ...
                              ▼
                  [MARKET_MAKER]/Soberanía returns signed [PACK_TYPE] + provenance hashes
...
Soberanía enforces: consent validity, capability checks (audience/scope/expiry/nonce), integrity verification.
...
[BUYER] submits a scoped request to [MARKET_MAKER], [SUBJECT] approves exact disclosure terms in wallet, payment is split, Soberanía mints a constrained capability after payment success, and [BUYER] redeems that capability to receive a signed, hash-verifiable [PACK_TYPE].
...
On approval, [BUYER] pays P; payout is split per policy ([SUBJECT_SHARE], [MM_SHARE], [PROTOCOL_SHARE]). Soberanía mints a scoped, expiring, audience-bound capability only after payment success.
