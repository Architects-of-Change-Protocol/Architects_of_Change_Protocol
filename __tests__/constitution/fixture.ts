...
export const writeRatificationGovernance = (fixture: ConstitutionalFixture, options: {
  version?: string;
  amendmentId?: string;
} = {}) => {
  const version = options.version ?? 'v1.0';
  const amendmentId = options.amendmentId ?? 'AOC-AMD-0001';
  writeAuditGovernance(fixture, { version, amendmentId });
  writeConstitutionalGovernance(fixture, { version, amendmentId, affectedAuthorities: 'Constitution; Ratification Authorities RAT-0001 through RAT-0010' });

  const ratDefs = [
    ['RAT-0001', 'Constitution Ratification Authority', 'Constitutional', 'Constitution'],
    ['RAT-0002', 'Ratification Readiness Authority', 'Constitutional', 'Constitution'],
    ['RAT-0003', 'Ratification Decision Authority', 'Constitutional', 'Constitution'],
    ['RAT-0004', 'Ratification Signature Authority', 'Constitutional', 'Constitution'],
    ['RAT-0005', 'Ratification Release Authority', 'Constitutional', 'Constitution'],
    ['RAT-0006', 'Ratification Amendment Lock Authority', 'Constitutional', 'Constitution'],
    ['RAT-0007', 'Ratification Certification Authority', 'Certification', 'Constitution'],
    ['RAT-0008', 'Ratification Audit Authority', 'Constitutional', 'Constitution'],
    ['RAT-0009', 'Ratification Publication Authority', 'Governance', 'Constitution'],
    ['RAT-0010', 'Ratification Supersession Authority', 'Constitutional', 'Constitution'],
  ] as const;

  const ratRows = ratDefs.map(([id, name, cls, owner]) =>
    `| ${id} | ${name} | ${cls} | ${owner} | ${amendmentId} | Canonical |`
  ).join('\n');

  fixture.write('docs/constitution/RATIFICATION-CONSTITUTION.md', `# Ratification Constitution\n\n**Constitution Version:** ${version}\n\n## Preamble\n\nRatification is a governed constitutional act through which the completed constitutional system is formally adopted as the authoritative foundation for AOC Protocol governance.\n\nRatification is NOT audit, governance, voting, runtime execution, product launch, or package publication.\n\nRatification answers: Is this Constitution now authoritative?\n\n## Foundational Doctrine\n\n- Complete ≠ Ratified: A complete Constitution is not automatically authoritative.\n- Audited ≠ Ratified: An audited Constitution must still be formally adopted.\n- Ratified ≠ Immutable: A ratified Constitution may evolve through governed amendment.\n- v1.0 ≠ Final: v1.0 is the first sovereign baseline, not the end of constitutional evolution.\n\n## Constitutional Artifacts\n\n- \`RATIFICATION-AUTHORITIES.md\` — Ratification authority catalog\n- \`RATIFICATION-READINESS-POLICY.md\` — Ratification readiness policy\n- \`RATIFICATION-DECISION-POLICY.md\` — Ratification decision policy\n- \`RATIFICATION-SIGNATURE-POLICY.md\` — Ratification signature policy\n- \`RATIFICATION-RELEASE-POLICY.md\` — Ratification release policy\n- \`RATIFICATION-LIFECYCLE.md\` — Ratification lifecycle\n- \`RATIFICATION-AMENDMENT-LOCK-POLICY.md\` — Ratification amendment lock policy\n- \`RATIFICATION-VIOLATION-CATALOG.md\` — Ratification violation catalog\n\n## Creation Amendment\n\n${amendmentId}\n`);
  fixture.write('docs/constitution/RATIFICATION-AUTHORITIES.md', `# Ratification Authorities\n\n**Constitution Version:** ${version}\n\n## Ratification authority catalog\n\n| Ratification Authority ID | Ratification Authority Name | Authority Class | Owner | Amendment | Status |\n|---|---|---|---|---|---|\n${ratRows}\n`);
  fixture.write('docs/constitution/RATIFICATION-READINESS-POLICY.md', `# Ratification Readiness Policy\n\n**Constitution Version:** ${version}\n\n## Readiness Requirements\n\nRatification requires all of the following:\n\n- All constitutional domains exist.\n- All constitutional artifacts declare the same version.\n- All amendments are cataloged.\n- All protected files are governed.\n- All scanners pass.\n- All tests pass.\n- Audit matrix complete.\n- Gap analysis complete.\n- Integrity report complete.\n- No critical audit findings remain open.\n`);
  fixture.write('docs/constitution/RATIFICATION-DECISION-POLICY.md', `# Ratification Decision Policy\n\n**Constitution Version:** ${version}\n\n## Decision Requirements\n\nEvery ratification decision must include:\n\n- Decision ID\n- Constitution Version\n- Ratification Authority\n- Audit Reference\n- Readiness Reference\n- Integrity Reference\n- Outcome\n- Rationale\n- Effective Date\n- Status\n\n## Valid Outcomes\n\n- Ratified\n- Rejected\n- Deferred\n- Conditionally Ratified\n- Superseded\n\n## Decision Registry\n\n| Decision ID | Constitution Version | Ratification Authority | Audit Reference | Readiness Reference | Outcome | Effective Date | Status |\n|---|---|---|---|---|---|---|---|\n`);
  fixture.write('docs/constitution/RATIFICATION-SIGNATURE-POLICY.md', `# Ratification Signature Policy\n\n**Constitution Version:** ${version}\n\n## Signature Requirements\n\nEvery ratification signature must include:\n\n- Signature ID\n- Signer\n- Signer Authority\n- Constitution Version\n- Ratification Decision\n- Timestamp\n- Integrity Reference\n- Status\n\n## Governing Rule\n\nSignature records constitutional adoption. Signature does not create unilateral authority.\n\n## Signature Registry\n\n| Signature ID | Signer | Signer Authority | Constitution Version | Ratification Decision | Timestamp | Status |\n|---|---|---|---|---|---|---|\n`);
  fixture.write('docs/constitution/RATIFICATION-RELEASE-POLICY.md', `# Ratification Release Policy\n\n**Constitution Version:** ${version}\n\n## Release Requirements\n\nA ratified constitutional release must include:\n\n- Release ID\n- Constitution Version\n- Ratification Decision\n- Release Date\n- Release Artifacts\n- Integrity Reference\n- Supersession Rule\n- Status\n\n## Release Artifacts\n\n- CONSTITUTION.md\n- AOC-CONSTITUTION-v1.0.md\n- AMENDMENT-CATALOG.md\n- CONSTITUTION-VERSION-HISTORY.md\n- CONSTITUTIONAL-AUDIT-MATRIX.md\n- CONSTITUTIONAL-GAP-ANALYSIS.md\n- CONSTITUTIONAL-INTEGRITY-REPORT.md\n\n## Release Registry\n\n| Release ID | Constitution Version | Ratification Decision | Release Date | Status |\n|---|---|---|---|---|\n`);
  fixture.write('docs/constitution/RATIFICATION-LIFECYCLE.md', `# Ratification Lifecycle\n\n**Constitution Version:** ${version}\n\n## Ratification lifecycle states\n\n| State | Description |\n|---|---|\n| Draft | Constitution under construction |\n| Readiness Review | Constitution undergoing ratification readiness assessment |\n| Pending Decision | Readiness confirmed; awaiting ratification decision |\n| Ratified | Constitution formally adopted as sovereign authority |\n| Released | Ratified constitution published as versioned baseline |\n| Superseded | Constitution superseded by a newer ratified version |\n| Rejected | Constitution rejected; ratification not granted |\n| Retired | Constitution withdrawn from all active use |\n\n## Ratification lifecycle transition ledger\n\n| Transition ID | Constitution Version | From | To | Authorized By | Evidence | Amendment | Effective Date |\n|---|---|---|---|---|---|---|---|\n`);
  fixture.write('docs/constitution/RATIFICATION-AMENDMENT-LOCK-POLICY.md', `# Ratification Amendment Lock Policy\n\n**Constitution Version:** ${version}\n\n## Purpose\n\nPrevent uncontrolled constitutional drift during ratification.\n\n## Lock Rules\n\n- No new constitutional domain may be introduced during ratification.\n- Only remediation, parity, audit, ratification, and release changes are allowed during ratification.\n- Any post-ratification constitutional change must use the amendment process.\n- v1.0 becomes the sovereign baseline.\n- Future changes become v1.x or v2.0 according to amendment class.\n`);
  fixture.write('docs/constitution/RATIFICATION-VIOLATION-CATALOG.md', `# Ratification Violation Catalog\n\n**Constitution Version:** ${version}\n\n## Violation Registry\n\n| Violation ID | Name | Severity | Description | Amendment |\n|---|---|---|---|---|\n| RAT-V-001 | Ratification Without Audit | Critical | Ratification attempted without completed constitutional audit | ${amendmentId} |\n| RAT-V-002 | Ratification With Open Critical Findings | Critical | Ratification attempted with unresolved critical audit findings | ${amendmentId} |\n| RAT-V-003 | Ratification Without Readiness Evidence | Critical | Ratification attempted without documented readiness evidence | ${amendmentId} |\n| RAT-V-004 | Ratification Without Decision | Critical | Constitution declared ratified without a ratification decision record | ${amendmentId} |\n| RAT-V-005 | Ratification Without Signature | High | Ratification decision recorded without a signature record | ${amendmentId} |\n| RAT-V-006 | Ratification Without Release Artifact | High | Ratification completed without publishing required release artifacts | ${amendmentId} |\n| RAT-V-007 | Unauthorized Ratification | Critical | Ratification performed by an authority without ratification standing | ${amendmentId} |\n| RAT-V-008 | Amendment During Lock | Critical | Constitutional domain introduced during ratification amendment lock | ${amendmentId} |\n| RAT-V-009 | Ratification Integrity Failure | Critical | Ratification artifact version parity violation detected | ${amendmentId} |\n| RAT-V-010 | Ratification Traceability Failure | High | Ratification artifact cannot be traced to required dimension | ${amendmentId} |\n| RAT-V-011 | Release Identity Failure | High | Ratified release lacks required release identity fields | ${amendmentId} |\n| RAT-V-012 | Sovereign Baseline Failure | Critical | v1.0 sovereign baseline not declared or not traceable | ${amendmentId} |\n`);
};
