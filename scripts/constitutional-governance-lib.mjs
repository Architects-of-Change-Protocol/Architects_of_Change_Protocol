...
export const PROTECTED_CONSTITUTIONAL_FILES = Object.freeze([
  ...
  `${CONSTITUTION_DIR}/REPUTATION-CONSTITUTION.md`,
  `${CONSTITUTION_DIR}/REPUTATION-AUTHORITIES.md`,
  `${CONSTITUTION_DIR}/REPUTATION-SOURCES-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-LIFECYCLE.md`,
  `${CONSTITUTION_DIR}/REPUTATION-CALCULATION-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-DECAY-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-DISPUTE-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-CORRECTION-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-REVOCATION-POLICY.md`,
  `${CONSTITUTION_DIR}/REPUTATION-VIOLATION-CATALOG.md`,
]);
