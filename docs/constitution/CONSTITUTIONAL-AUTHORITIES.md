...
| Constitution | `docs/constitution` | Owns constitutional authority, laws, policies, amendment procedure, amendment catalog, authority catalog, version history, scanners, and release gate obligations. | AOC-AMD-0001 | Not scheduled | Canonical |
