import { IdentityVerificationEngine } from '../verification/identity-verification';
export class InMemoryTrustService {
    ...
    consents = new Map();
    auditEvents = [];
    constructor(initialIssuers = [], verificationEngine = new IdentityVerificationEngine()) {
...
export const DEFAULT_TRUST_ISSUERS = [
    {
